...
public interface UserStatisticDao extends BaseMapper<UserStatisticModel> {
    ...
    StatisHomeVO findHomeUserStatisticByAgencyIdAndDate(@Param("agencyId") Integer agencyId, @Param("date") String date);


    StatisHomeVO findHomeUserStatisticAuthByAgencyIdAndDate(@Param("agencyId") Integer agencyId, @Param("date") String date);
