...
public final class ConfigManager {
     ...
     */
    private ConfigManager(String rootPath) {
    ...
    public void initEnv(Resource resource) throws IOException {

        String configContent = IOUtils.toString(resource.getInputStream());
